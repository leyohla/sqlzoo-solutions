...
/* Quesion 1: The example uses a WHERE clause to show the population of 'France'. 
...
/* Question 2: Checking a list The word IN allows us to check if an item is in a list. 
...
/* Question 3: Which countries are not too small and not too big? BETWEEN allows range checking 
